...
# =========================================================================
# --- SELETOR DE PASTA BLINDADO (ESTILO ÁRVORE) ---
# =========================================================================
function Show-FolderSelectionDialog {
    ...
    # --- A OPÇÃO NUCLEAR ---
    $selForm.FormBorderStyle = "None"
    $selForm.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::None
    $selForm.BackColor = [System.Drawing.Color]::White
    ...
    # --- BLINDAGEM DPI: Fontes ---
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 13, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    $regularFont = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)

    # =========================================================================
    # --- BARRA DE TÍTULO CUSTOMIZADA BLINDADA ---
    # =========================================================================
    $selTitleBar = New-Object System.Windows.Forms.Panel
    $selTitleBar.Dock = "Top"; $selTitleBar.Height = 32; $selTitleBar.BackColor = [System.Drawing.Color]::WhiteSmoke
    $selForm.Controls.Add($selTitleBar)

    $btnSelClose = New-Object System.Windows.Forms.Button
    $btnSelClose.Dock = "Right"; $btnSelClose.Width = 45; $btnSelClose.FlatStyle = "Flat"
    $btnSelClose.FlatAppearance.BorderSize = 0; $btnSelClose.Text = "X"
    $btnSelClose.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $btnSelClose.Cursor = [System.Windows.Forms.Cursors]::Hand
    $btnSelClose.Add_Click({ $selForm.DialogResult = "Cancel"; $selForm.Close() })
    $btnSelClose.Add_MouseEnter({ $btnSelClose.BackColor = "Red"; $btnSelClose.ForeColor = "White" })
    $btnSelClose.Add_MouseLeave({ $btnSelClose.BackColor = "Transparent"; $btnSelClose.ForeColor = "Black" })
    $selTitleBar.Controls.Add($btnSelClose)

    $lblSelTitle = New-Object System.Windows.Forms.Label
    $lblSelTitle.Dock = "Fill"; $lblSelTitle.Text = "  Selecionar Pasta"; $lblSelTitle.TextAlign = "MiddleLeft"
    $lblSelTitle.Font = $boldFont
    $selTitleBar.Controls.Add($lblSelTitle)

    # --- LÓGICA DE ARRASTAR A JANELA ---
    $dragSelVars = @{ IsDragging = $false; StartPoint = $null }
    $startSelDrag = { param($s, $e) if ($e.Button -eq 'Left') { $dragSelVars.IsDragging = $true; $dragSelVars.StartPoint = New-Object System.Drawing.Point($e.X, $e.Y) } }.GetNewClosure()
    $doSelDrag = { param($s, $e) if ($dragSelVars.IsDragging) { $mousePos = [System.Windows.Forms.Cursor]::Position; $selForm.Location = New-Object System.Drawing.Point(($mousePos.X - $dragSelVars.StartPoint.X), ($mousePos.Y - $dragSelVars.StartPoint.Y)) } }.GetNewClosure()
    $stopSelDrag = { $dragSelVars.IsDragging = $false }.GetNewClosure()

    $selTitleBar.Add_MouseDown($startSelDrag); $lblSelTitle.Add_MouseDown($startSelDrag)
    $selTitleBar.Add_MouseMove($doSelDrag); $lblSelTitle.Add_MouseMove($doSelDrag)
    $selTitleBar.Add_MouseUp($stopSelDrag); $lblSelTitle.Add_MouseUp($stopSelDrag)
    # =========================================================================
    ...
    $lbl.BringToFront() # Garante que fica debaixo da barra de titulo
    ...
    $btnNew.Text = "Nova Pasta"; $btnNew.Width = 100; $btnNew.Height = 30; $btnNew.Font = $regularFont
    $btnNew.Location = New-Object System.Drawing.Point($startX, $btnY)
    $pnlBtns.Controls.Add($btnNew)

    $btnOk = New-Object System.Windows.Forms.Button
    $btnOk.Text = "Salvar Aqui"; $btnOk.DialogResult = "OK"; $btnOk.Width = 100; $btnOk.Height = 30; $btnOk.Font = $regularFont
    ...
    function Refresh-UI {
        ...
        # Removido o NodeFont daqui para o Windows não cortar a palavra
        ...
        function Build-Tree($parentNode, $childrenData) {
            ...
            foreach ($item in @($childrenData)) {
                if ($item.Type -eq "Folder") {
                    ...
                    # Removido o NodeFont daqui também
    ...
    $btnNew.Add_Click({
        ...
        if ($selNode -ne $null) {
            ...
            # --- MINI-JANELA DE NOVA PASTA BLINDADA ---
            $input = New-Object System.Windows.Forms.Form
            $input.Text = "Nome da Pasta"; $input.Size = New-Object System.Drawing.Size(250, 120)
            $input.StartPosition = "CenterParent"
            
            # Blindagem DPI
            $input.FormBorderStyle = "FixedToolWindow"
            $input.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::None
            
            $tb = New-Object System.Windows.Forms.TextBox
            $tb.Location = New-Object System.Drawing.Point(10, 10); $tb.Width=210
            $tb.Font = $regularFont
            $input.Controls.Add($tb)
            
            $bk = New-Object System.Windows.Forms.Button
            $bk.Text="OK"; $bk.DialogResult="OK"; $bk.Location=New-Object System.Drawing.Point(140, 40)
            $bk.Font = $regularFont
            ...
            if ($input.ShowDialog() -eq "OK" -and -not [string]::IsNullOrWhiteSpace($tb.Text)) {
                ...
                # ==============================================================
                # MÁGICA DO AGRUPAMENTO (Pastas sempre no topo, Links embaixo)
                # ==============================================================
                $tempChildren = @($parent.Children) + $newFolder
                
                $pastas = @($tempChildren | Where-Object { $_.Type -eq 'Folder' })
                $links  = @($tempChildren | Where-Object { $_.Type -ne 'Folder' })
                
                $parent.Children = $pastas + $links
                # ==============================================================
...
# --- BLINDAGEM DPI: Carrega a Pasta (3) e o Link (297) cravados em 16x16 ---
if ($null -eq $global:FolderIconBmp) { 
    try { 
        $rawFolder = [BookmarkIcons]::GetIcon("shell32.dll", 3)
        $global:FolderIconBmp = New-Object System.Drawing.Bitmap($rawFolder, 16, 16)
        $rawFolder.Dispose()
    } catch {} 
}
if ($null -eq $global:LinkIconBmp) { 
    try { 
        $rawLink = [BookmarkIcons]::GetIcon("shell32.dll", 297)
        $global:LinkIconBmp = New-Object System.Drawing.Bitmap($rawLink, 16, 16)
        $rawLink.Dispose()
    } catch {} 
}
    ...
    try { 
        ...
        function Add-Outline($bmpOriginal, $isGray) {
            ...
            if ($isGray) {
                ...
                $rect = New-Object System.Drawing.Rectangle(0, 0, $w, $h)
                $g.DrawImage($bmpOriginal, $rect, 0, 0, $w, $h, [System.Drawing.GraphicsUnit]::Pixel)
            }
        ...
        # O TRUQUE MESTRE DA BLINDAGEM: 
        # Passar pelo construtor (16, 16) sincroniza o DPI da imagem com o do ecrã, 
        # impedindo o Windows Forms de a tentar esticar!
        $rawStarFull = Add-Outline $origBmp $false
        $rawStarEmpty = Add-Outline $origBmp $true
        
        $global:StarIconBmp = New-Object System.Drawing.Bitmap($rawStarFull, 16, 16)
        $global:StarEmptyIconBmp = New-Object System.Drawing.Bitmap($rawStarEmpty, 16, 16)
        
        $rawStarFull.Dispose()
        $rawStarEmpty.Dispose()
        $origBmp.Dispose()
    } catch {} 
}
...
function Show-BookmarkManager {
    ...
    # --- A OPÇÃO NUCLEAR: CORTA A BARRA DO WINDOWS PELA RAIZ ---
    $mgrForm.FormBorderStyle = "None"
    $mgrForm.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::None

    # Desenha uma borda manual fina para a janela não ficar "voando" sem limites
    $mgrForm.Add_Paint({
        param($s, $e)
        $pen = New-Object System.Drawing.Pen([System.Drawing.Color]::Gray, 1)
        $e.Graphics.DrawRectangle($pen, 0, 0, ($s.Width - 1), ($s.Height - 1))
    ...
    # --- BLINDAGEM DPI: Fontes do Gerenciador travadas em Píxeis ---
    $boldFont = New-Object System.Drawing.Font("Segoe UI", 13, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    $regularFont = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $btnFont = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)

    # =========================================================================
    # --- 1. BARRA DE TÍTULO CUSTOMIZADA (A NOSSA PRÓPRIA BARRA BLINDADA) ---
    # =========================================================================
    $customTitleBar = New-Object System.Windows.Forms.Panel
    $customTitleBar.Dock = "Top"
    $customTitleBar.Height = 32
    $customTitleBar.BackColor = [System.Drawing.Color]::WhiteSmoke
    $mgrForm.Controls.Add($customTitleBar)

    # Botão de Fechar Customizado (O "X")
    ...
    $btnClose.Text = "X"
    $btnClose.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $btnClose.Cursor = [System.Windows.Forms.Cursors]::Hand
    $btnClose.Add_Click({ $mgrForm.Close() })

    # Efeito visual para ficar parecido com o Windows
    $btnClose.Add_MouseEnter({ $btnClose.BackColor = "Red"; $btnClose.ForeColor = "White" })
    $btnClose.Add_MouseLeave({ $btnClose.BackColor = "Transparent"; $btnClose.ForeColor = "Black" })
    $customTitleBar.Controls.Add($btnClose)

    $lblTitle = New-Object System.Windows.Forms.Label
    $lblTitle.Dock = "Fill"
    $lblTitle.Text = "  Gerenciador de Marcadores"
    $lblTitle.TextAlign = "MiddleLeft"
    $lblTitle.Font = $boldFont
    $customTitleBar.Controls.Add($lblTitle)

    # --- LÓGICA DE ARRASTAR A JANELA ---
    $dragVars = @{ IsDragging = $false; StartPoint = $null }

    $startDrag = {
        param($s, $e)
        if ($e.Button -eq 'Left') {
            $dragVars.IsDragging = $true
            $dragVars.StartPoint = New-Object System.Drawing.Point($e.X, $e.Y)
        }
    }.GetNewClosure()
    ...
    $doDrag = {
        ...
        if ($dragVars.IsDragging) {
            ...
            $mgrForm.Location = New-Object System.Drawing.Point(($mousePos.X - $dragVars.StartPoint.X), ($mousePos.Y - $dragVars.StartPoint.Y))
        }
    }.GetNewClosure()

    $stopDrag = { $dragVars.IsDragging = $false }.GetNewClosure()

    $customTitleBar.Add_MouseDown($startDrag); $lblTitle.Add_MouseDown($startDrag)
    $customTitleBar.Add_MouseMove($doDrag); $lblTitle.Add_MouseMove($doDrag)
    $customTitleBar.Add_MouseUp($stopDrag); $lblTitle.Add_MouseUp($stopDrag)
    # =========================================================================

    # --- BARRA DE ENDEREÇO (TOPO - AGORA ABAIXO DA BARRA DE TÍTULO) ---
    ...
    $topPanel.BringToFront() # Garante que fica abaixo da barra de título

    $btnUp = New-Object System.Windows.Forms.Button
    $btnUp.Text = "Voltar"
    $btnUp.Font = $regularFont # <--- BLINDAGEM DPI APLICADA
    ...
    $txtPath.Font = $boldFont # <--- BLINDAGEM DPI APLICADA
    ...
    $listView.Location = New-Object System.Drawing.Point(10, 85) # Ajustado o Y (50 + 35) por causa da nova barra
    ...
    $btnPanel.Location = New-Object System.Drawing.Point(480, 85) # Ajustado o Y por causa da nova barra
    ...
    function New-MgrBtn($Txt, $Act) {
        ...
        $b.Font = $btnFont # Aplica a armadura aos botões laterais!
    ...
    function Show-NameDialog($tituloJanela, $textoPadrao) {
        ...
        # --- BLINDAGEM DPI ADICIONADA: Desliga a escala automática ---
        ...
        $lblNome.Text = "Nome:"
        $lblNome.Font = $regularFont # --- BLINDAGEM DPI ---
        ...
        $btnCancela.Font = $regularFont # --- BLINDAGEM DPI ---
    ...
    New-MgrBtn "Renomear" { 
        if ($listView.SelectedItems.Count -gt 0) { 
            ...
            # SUBSTITUÍDO
            Show-MsgBox "Selecione um item para renomear."
        }
    }
    ...
    New-MgrBtn "Excluir" { 
        if ($listView.SelectedItems.Count -gt 0) {
            ...
            # SUBSTITUÍDO (Usando a opção "YesNo")
            $resposta = Show-MsgBox $msg "Confirmar Exclusão" "YesNo"
    ...
    New-MgrBtn "Mover para..." {
        if ($listView.SelectedItems.Count -eq 0) { 
            # SUBSTITUÍDO
            Show-MsgBox "Selecione um item valido para mover."
            return 
        }
        ...
        # --- A OPÇÃO NUCLEAR: CORTA A BARRA DO WINDOWS PELA RAIZ ---
        $moveForm.FormBorderStyle = "None"
        $moveForm.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::None

        # Desenha uma borda manual fina
        $moveForm.Add_Paint({
            param($s, $e)
            $pen = New-Object System.Drawing.Pen([System.Drawing.Color]::Gray, 1)
            $e.Graphics.DrawRectangle($pen, 0, 0, ($s.Width - 1), ($s.Height - 1))
        ...
        # --- BARRA DE TÍTULO CUSTOMIZADA BLINDADA ---
        # =========================================================================
        $moveTitleBar = New-Object System.Windows.Forms.Panel
        $moveTitleBar.Dock = "Top"
        $moveTitleBar.Height = 32
        $moveTitleBar.BackColor = [System.Drawing.Color]::WhiteSmoke
        $moveForm.Controls.Add($moveTitleBar)

        $btnMoveClose = New-Object System.Windows.Forms.Button
        $btnMoveClose.Dock = "Right"
        $btnMoveClose.Width = 45
        $btnMoveClose.FlatStyle = "Flat"
        $btnMoveClose.FlatAppearance.BorderSize = 0
        $btnMoveClose.Text = "X"
        $btnMoveClose.Font = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
        $btnMoveClose.Cursor = [System.Windows.Forms.Cursors]::Hand
        $btnMoveClose.Add_Click({ $moveForm.DialogResult = "Cancel"; $moveForm.Close() })
        $btnMoveClose.Add_MouseEnter({ $btnMoveClose.BackColor = "Red"; $btnMoveClose.ForeColor = "White" })
        $btnMoveClose.Add_MouseLeave({ $btnMoveClose.BackColor = "Transparent"; $btnMoveClose.ForeColor = "Black" })
        $moveTitleBar.Controls.Add($btnMoveClose)

        $lblMoveTitle = New-Object System.Windows.Forms.Label
        $lblMoveTitle.Dock = "Fill"
        $lblMoveTitle.Text = "  Mover: $($itemToMove.Name)"
        $lblMoveTitle.TextAlign = "MiddleLeft"
        $lblMoveTitle.Font = $boldFont # Usa a fonte blindada do formulário pai
        $moveTitleBar.Controls.Add($lblMoveTitle)

        # --- LÓGICA DE ARRASTAR A JANELA ---
        $dragMoveVars = @{ IsDragging = $false; StartPoint = $null }
        $startMoveDrag = { param($s, $e) if ($e.Button -eq 'Left') { $dragMoveVars.IsDragging = $true; $dragMoveVars.StartPoint = New-Object System.Drawing.Point($e.X, $e.Y) } }.GetNewClosure()
        $doMoveDrag = { param($s, $e) if ($dragMoveVars.IsDragging) { $mousePos = [System.Windows.Forms.Cursor]::Position; $moveForm.Location = New-Object System.Drawing.Point(($mousePos.X - $dragMoveVars.StartPoint.X), ($mousePos.Y - $dragMoveVars.StartPoint.Y)) } }.GetNewClosure()
        $stopMoveDrag = { $dragMoveVars.IsDragging = $false }.GetNewClosure()

        $moveTitleBar.Add_MouseDown($startMoveDrag); $lblMoveTitle.Add_MouseDown($startMoveDrag)
        $moveTitleBar.Add_MouseMove($doMoveDrag); $lblMoveTitle.Add_MouseMove($doMoveDrag)
        $moveTitleBar.Add_MouseUp($stopMoveDrag); $lblMoveTitle.Add_MouseUp($stopMoveDrag)
        # =========================================================================

        $moveTree = New-Object System.Windows.Forms.TreeView
        $moveTree.Location = New-Object System.Drawing.Point(10, 42) 
        $moveTree.Size = New-Object System.Drawing.Size(315, 350)
        $moveTree.ImageList = $imgList
        
        # --- A CURA PARA O TEXTO CORTADO ---
        # 1. Aplicamos a fonte maior diretamente na base da árvore para o Windows calcular certo
        $moveTree.Font = $regularFont 
        # 2. Damos um espaçamento vertical fixo para as linhas não ficarem esmagadas
        $moveTree.ItemHeight = 24 
        ...
        $btnOk.Location = New-Object System.Drawing.Point(125, 402) 
        $btnOk.Size = New-Object System.Drawing.Size(100, 30)
        $btnOk.Font = $regularFont 
        ...
        # Removemos o NodeFont daqui para não confundir o motor do Windows
        ...
        function Build-MoveTree($parentNode, $childrenData) {
            ...
            foreach ($item in @($childrenData)) {
                if ($item.Type -eq "Folder" -and $item -ne $itemToMove) {
                    ...
                    # Removemos o NodeFont daqui também
    ...
    New-MgrBtn "SALVAR E SAIR" {
        ...
        # SUBSTITUÍDO
        Show-MsgBox "Marcadores salvos!" "Sucesso"
        $mgrForm.Close()
    }
...
function Build-ContextMenu($menuItems, $dataList, $tControl) {
    foreach ($item in $dataList) {
        if ($item.Type -eq 'Folder') {
            ...
            # --- BLINDAGEM DPI 1: Fonte da Pasta (Negrito) em Píxeis ---
            $subItem.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
            
            # --- BLINDAGEM DPI 2: Trava o inchaço dos ícones nos Submenus flutuantes ---
            $subItem.DropDown.ImageScalingSize = New-Object System.Drawing.Size(16, 16)
            ...
            if ($item.Children) {
                # Repassa a trava do controle para as subpastas!
                Build-ContextMenu $subItem.DropDownItems $item.Children $tControl
            }
        } else {
            $linkItem = $menuItems.Add($item.Name)
            
            # --- BLINDAGEM DPI 3: Fonte do Link (Normal) em Píxeis ---
            $linkItem.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
            ...
            $linkItem.Add_Click({ 
                ...
                if (-not $isVirt) {
                    if (-not (Test-Path -LiteralPath $targetPath -ErrorAction SilentlyContinue)) {
                        # --- BLINDAGEM DPI: Usando a nossa Mensagem Customizada ---
                        global:Show-MsgBox "O local selecionado se encontra indisponível no momento ou deixou de existir.`n`nCaminho: $targetPath" "Marcador Indisponível" "OK"
                        return # Bloqueia a ordem de navegação e protege a aba!
                    }
                }

                # ====================================================================
                # A CORREÇÃO: Força o clique a usar APENAS o lado correto!
                # ====================================================================
                if ($tControl -and $tControl.SelectedTab -and $tControl.SelectedTab.Controls.Count -gt 0) {
                    $b = $tControl.SelectedTab.Controls[0]
                    $b.Navigate($targetPath)
                } elseif ($global:ActiveBrowser) {
                    # Plano B de Segurança
                    $global:ActiveBrowser.Navigate($targetPath)
                }
...
$form.Text = "Clone Commander v1.3"
$form.Size = New-Object System.Drawing.Size(1100, 600)
$form.StartPosition = "CenterScreen"
$form.KeyPreview = $true 

# ====================================================================
# --- GERADOR DE ÍCONE DINÂMICO NATIVO (BLINDADO CONTRA DPI) ---
# ====================================================================
try {
    # 1. BLINDAGEM DPI: Pergunta ao Windows qual é o tamanho EXATO que a barra de tarefas exige na escala atual (ex: a 175%, será cerca de 56x56)
    $iconSize = [System.Windows.Forms.SystemInformation]::SmallIconSize
    $w = $iconSize.Width
    $h = $iconSize.Height

    # 2. Cria a tela transparente com as medidas perfeitas para o ecrã atual
    $bmp = New-Object System.Drawing.Bitmap($w, $h)
    $gfx = [System.Drawing.Graphics]::FromImage($bmp)
    
    # Alta qualidade de desenho para não ficar pixelizado
    ...
    # 3. BLINDAGEM DPI DA FONTE: Calcula o tamanho da fonte proporcionalmente ao tamanho do Canvas (aprox. 80% do espaço) e trava em Píxeis (GraphicsUnit.Pixel)
    $fontSizePx = [int]($w * 0.8)
    $font = New-Object System.Drawing.Font("Segoe MDL2 Assets", $fontSizePx, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    
    # Centraliza o desenho na tela de forma perfeita
    ...
    # Converte a imagem gerada para o formato Icon e aplica na Janela
    $hIcon = $bmp.GetHicon()
    $form.Icon = [System.Drawing.Icon]::FromHandle($hIcon)
    
    # Limpa as ferramentas de pintura da memória
    $gfx.Dispose(); $font.Dispose(); $brush.Dispose(); $format.Dispose()
...
# --- BLINDAGEM DPI 1: DESLIGA A ESCALA AUTOMÁTICA DA JANELA ---
...
$lblTitle = New-Object System.Windows.Forms.Label
$lblTitle.Dock = "Fill"
$lblTitle.Text = "   Clone Commander v1.3"
$lblTitle.ForeColor = "Black"  # <--- TEXTO ESCURO PARA DAR CONTRASTE

# --- BLINDAGEM DPI 2: FONTES EM PÍXEIS (9 pt virou 12 px) ---
$lblTitle.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
$lblTitle.TextAlign = "MiddleLeft"
...
function New-TitleBtn($Text, $ColorHover, $FontSizePx, $PosX) {
    $b = New-Object System.Windows.Forms.Button
    ...
    # --- BLINDAGEM DPI: FONTE EM PÍXEIS ---
    $b.Font = New-Object System.Drawing.Font("Segoe MDL2 Assets", $FontSizePx, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $b.Text = $Text
...
# 1. BOTÃO DE AJUDA (?) - Posição X: 0 (12 pt virou 16 px)
$btnHelpApp = New-TitleBtn "?" "#E5E5E5" 16 0
$btnHelpApp.Font = New-Object System.Drawing.Font("Segoe UI", 15, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
...
$btnHelpApp.Add_Click({
    ...
    # --- BLINDAGEM DPI ADICIONADA: Desliga a escala automática ---
    $helpForm.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::None
    ...
    # Textos da Ajuda (Fontes em Píxeis absolutos)
    $rtb.SelectionFont = New-Object System.Drawing.Font("Segoe UI", 21, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    $rtb.AppendText("Guia de Atalhos e Funcionalidades Exclusivas`n`n")
    
    $rtb.SelectionFont = New-Object System.Drawing.Font("Segoe UI", 16, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    $rtb.AppendText("Manipulação de Abas`n")
    $rtb.SelectionFont = New-Object System.Drawing.Font("Segoe UI", 13, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
...
# 2. BOTÃO MINIMIZAR (_) - Posição X: 45 (10 pt virou 13 px)
$btnMinApp = New-TitleBtn ([char]0xE921) "#E5E5E5" 13 45
$btnMinApp.Add_Click({ $form.WindowState = 'Minimized' })
$pnlWindowBtns.Controls.Add($btnMinApp)

# 3. BOTÃO MAXIMIZAR ([ ]) - Posição X: 90 (10 pt virou 13 px)
$btnMaxApp = New-TitleBtn ([char]0xE922) "#E5E5E5" 13 90
$btnMaxApp.Add_Click({
    if ($form.WindowState -eq 'Maximized') { 
...
# 4. BOTÃO FECHAR (X) - Posição X: 135 (10 pt virou 13 px)
$btnCloseApp = New-TitleBtn ([char]0xE8BB) "#E81123" 13 135
...
function New-CmdButton {
    ...
    # --- BLINDAGEM DPI: Trava a fonte de Símbolos em Píxeis absolutos ---
    $btn.Font = New-Object System.Drawing.Font("Segoe MDL2 Assets", 20, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
...
# --- BLINDAGEM DPI: Trava a Seta (que é um pouco maior) em Píxeis absolutos ---
$lblDirection.Font = New-Object System.Drawing.Font("Segoe MDL2 Assets", 30, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
...
# --- BLINDAGEM DPI: Trava o ícone do Modo Turbo em Píxeis absolutos ---
$lblTurbo.Font = New-Object System.Drawing.Font("Segoe MDL2 Assets", 24, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
...
$directionTimer.Add_Tick({
    if ($global:ActiveBrowser -ne $null) {
        ...
        try {
            ...
            # --- NOVA LÓGICA DIRECIONAL (ORIGEM E DESTINO) ---
            $sourceBrowser = $global:ActiveBrowser
            $targetBrowser = $null

            # Descobre quem é o alvo (o painel oposto ao selecionado)
            if ($isLeftActive) {
                $targetBrowser = if ($global:RightTabControl -and $global:RightTabControl.SelectedTab) { $global:RightTabControl.SelectedTab.Controls[0] } else { $null }
            } elseif ($isRightActive) {
                $targetBrowser = if ($global:LeftTabControl -and $global:LeftTabControl.SelectedTab) { $global:LeftTabControl.SelectedTab.Controls[0] } else { $null }
            }

            $sourceStatus = & $CheckRestricted $sourceBrowser
            $targetStatus = & $CheckRestricted $targetBrowser

            # Status[0] = Meu Computador | Status[1] = Lixeira
            
            # 1. Se o DESTINO for Meu Computador, não há onde colar arquivos. Bloqueia Copiar e Mover.
            if ($targetStatus[0]) {
                $allowCopy = $false
                $allowMove = $false
            }

            # 2. Se a ORIGEM for Meu Computador, podemos Copiar (ex: um Disco inteiro), mas não Mover.
            if ($sourceStatus[0]) {
                $allowMove = $false
                $allowDelete = $false
            }

            # 3. Regra da Lixeira (Bloqueia transferências se estiver envolvida)
            if ($sourceStatus[1] -or $targetStatus[1]) {
                $allowCopy = $false
                $allowMove = $false
            }
...
$PerformFileAction = {
    ...
    if ($selectedItems.Count -eq 0) {
        Show-MsgBox "Selecione pelo menos um arquivo ou pasta para transferir." "Aviso" # Usando o blindado!
    ...
    try {
        ...
        Show-MsgBox "Erro ao transferir: $_" "Erro" # Usando o blindado!
    }
...
function New-BrowserPane {
    ...
    # --- BLINDAGEM DPI: Trava a fonte das abas em 12 píxeis! ---
    $tabControl.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # --- BLINDAGEM DPI DO MENU ---
    $ctxMenu.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $ctxMenu.ImageScalingSize = New-Object System.Drawing.Size(16, 16)
    ...
    $btnBookmarks.Add_Click({
        ...
        $itemMgr = $ctxMenu.Items.Add("Gerenciador de Marcadores")
        
        # --- BLINDAGEM DPI: Fonte travada em píxeis absolutos ---
        $itemMgr.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
        
        $itemMgr.Add_Click({ Show-BookmarkManager })
        [void]$ctxMenu.Items.Add("-")
        $data = Get-BookmarksData; if ($data -and $data.Children) { Build-ContextMenu $ctxMenu.Items $data.Children $tabControl }
    ...
    # --- BLINDAGEM DPI DO MENU (Bloqueia o inchaço dos ícones e da fonte) ---
    $ctxShortcutsMenu.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $ctxShortcutsMenu.ImageScalingSize = New-Object System.Drawing.Size(16, 16)
    ...
    $shortcutsList = @(
        ...
        # Correção: O 'Name' continua com acento para visual, mas o 'Path' volta para 'Videos' sem acento para o motor encontrar
        @{ Name="Vídeos";           Path="$env:USERPROFILE\Videos";                        Dll="imageres.dll"; Icon= -189 }
    )
...
# --- BOTAO Exibição (MOVIDO PARA A DIREITA DOS ATALHOS) ---
    ...
    # --- BLINDAGEM DPI DO MENU (Bloqueia inchaço da fonte e dos "vistos"/checkmarks) ---
    $ctxViewMenu.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $ctxViewMenu.ImageScalingSize = New-Object System.Drawing.Size(16, 16)
...
# --- BOTAO CLASSIFICAR (A DIREITA DE Exibição) ---
    ...
    # --- BLINDAGEM DPI DO MENU (Bloqueia inchaço da fonte e dos vistos/checkmarks) ---
    $ctxSortMenu.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $ctxSortMenu.ImageScalingSize = New-Object System.Drawing.Size(16, 16)
...
'@
    ...
    try {
        ...
        $origIconBmp = [DllIconExtractor]::GetIcon($dllPath, 6)
        if ($origIconBmp -ne $null) {
            # --- BLINDAGEM DPI: Força o ícone a ter exatamente 16x16 píxeis ---
            $newSizePreview = New-Object System.Drawing.Size(16, 16)
            $btnPreview.Image = New-Object System.Drawing.Bitmap($origIconBmp, $newSizePreview)
            $origIconBmp.Dispose()
        }
    } catch {}
    ...
    # --- A OPÇÃO NUCLEAR: CORTA A BARRA DO WINDOWS PELA RAIZ ---
    $previewForm.FormBorderStyle = "None"
    $previewForm.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::None
    $previewForm.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#2D2D30")
    
    # Desenha uma borda manual fina
    $previewForm.Add_Paint({
        param($s, $e)
        $pen = New-Object System.Drawing.Pen([System.Drawing.Color]::Gray, 1)
        $e.Graphics.DrawRectangle($pen, 0, 0, ($s.Width - 1), ($s.Height - 1))
        $pen.Dispose()
    ...
    # FONTES BLINDADAS DO PREVIEW
    $fontPrevTitle = New-Object System.Drawing.Font("Segoe UI", 14, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    $fontPrevIcon = New-Object System.Drawing.Font("Segoe MDL2 Assets", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)

    # =========================================================================
    # --- BARRA DE TÍTULO CUSTOMIZADA DO PREVIEW (MÉTODO DE COORDENADAS ABSOLUTAS) ---
    # =========================================================================
    $prevTitleBar = New-Object System.Windows.Forms.Panel
    $prevTitleBar.Dock = "Top"
    $prevTitleBar.Height = 32
    $prevTitleBar.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#1E1E1E")
    $previewForm.Controls.Add($prevTitleBar)

    # 1. BOTÃO MINIMIZAR (Fica cravado a 135 pixels da borda direita)
    $btnPrevMin = New-Object System.Windows.Forms.Button
    $btnPrevMin.Location = New-Object System.Drawing.Point(($prevTitleBar.Width - 135), 0)
    $btnPrevMin.Size = New-Object System.Drawing.Size(45, 32)
    $btnPrevMin.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Right
    $btnPrevMin.FlatStyle = "Flat"
    $btnPrevMin.FlatAppearance.BorderSize = 0
    $btnPrevMin.Text = [char]0xE921 
    $btnPrevMin.Font = $fontPrevIcon
    $btnPrevMin.ForeColor = "White"
    
    # A Vacina Anti-Amnésia: Guardamos a janela dentro do botão
    $btnPrevMin.Tag = $previewForm 
    $btnPrevMin.Add_Click({ $this.Tag.WindowState = "Minimized" })
    $btnPrevMin.Add_MouseEnter({ $this.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#3F3F41") })
    $btnPrevMin.Add_MouseLeave({ $this.BackColor = [System.Drawing.Color]::Transparent })
    $prevTitleBar.Controls.Add($btnPrevMin)

    # 2. BOTÃO MAXIMIZAR/RESTAURAR (Fica cravado a 90 pixels da borda direita)
    $btnPrevMax = New-Object System.Windows.Forms.Button
    $btnPrevMax.Location = New-Object System.Drawing.Point(($prevTitleBar.Width - 90), 0)
    $btnPrevMax.Size = New-Object System.Drawing.Size(45, 32)
    $btnPrevMax.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Right
    $btnPrevMax.FlatStyle = "Flat"
    $btnPrevMax.FlatAppearance.BorderSize = 0
    $btnPrevMax.Text = [char]0xE922 
    $btnPrevMax.Font = $fontPrevIcon
    $btnPrevMax.ForeColor = "White"
    $btnPrevMax.Tag = $previewForm
    $btnPrevMax.Add_Click({
        if ($this.Tag.WindowState -eq "Normal") {
            $this.Tag.WindowState = "Maximized"
            $this.Text = [char]0xE923 
        } else {
            $this.Tag.WindowState = "Normal"
            $this.Text = [char]0xE922
        }
    })
    $btnPrevMax.Add_MouseEnter({ $this.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#3F3F41") })
    $btnPrevMax.Add_MouseLeave({ $this.BackColor = [System.Drawing.Color]::Transparent })
    $prevTitleBar.Controls.Add($btnPrevMax)

    # 3. BOTÃO FECHAR (Fica cravado a 45 pixels da borda direita)
    $btnPrevClose = New-Object System.Windows.Forms.Button
    $btnPrevClose.Location = New-Object System.Drawing.Point(($prevTitleBar.Width - 45), 0)
    $btnPrevClose.Size = New-Object System.Drawing.Size(45, 32)
    $btnPrevClose.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Right
    $btnPrevClose.FlatStyle = "Flat"
    $btnPrevClose.FlatAppearance.BorderSize = 0
    $btnPrevClose.Text = [char]0xE8BB
    $btnPrevClose.Font = $fontPrevIcon
    $btnPrevClose.ForeColor = "White"
    $btnPrevClose.Tag = $previewForm
    $btnPrevClose.Add_Click({ $this.Tag.Hide() })
    $btnPrevClose.Add_MouseEnter({ $this.BackColor = [System.Drawing.Color]::Red })
    $btnPrevClose.Add_MouseLeave({ $this.BackColor = [System.Drawing.Color]::Transparent })
    $prevTitleBar.Controls.Add($btnPrevClose)

    # TÍTULO DA JANELA (Ancorado à esquerda para não sobrepor os botões)
    $lblPrevTitle = New-Object System.Windows.Forms.Label
    $lblPrevTitle.Location = New-Object System.Drawing.Point(0, 0)
    $lblPrevTitle.Size = New-Object System.Drawing.Size(($prevTitleBar.Width - 135), 32)
    $lblPrevTitle.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Left -bor [System.Windows.Forms.AnchorStyles]::Right
    $lblPrevTitle.Text = "  Preview ($sideName)"
    $lblPrevTitle.TextAlign = "MiddleLeft"
    $lblPrevTitle.Font = $fontPrevTitle
    $lblPrevTitle.ForeColor = "White"
    $prevTitleBar.Controls.Add($lblPrevTitle)

    # --- LÓGICA DE ARRASTAR A JANELA DO PREVIEW ---
    # Criamos um "Módulo de Memória" seguro em HashTable
    $dragPrevVars = @{ IsDragging = $false; StartPoint = $null; Form = $previewForm; MaxBtn = $btnPrevMax }
    ...
    $startPrevDrag = { 
        ...
        if ($e.Button -eq 'Left') { 
            ...
            if ($f.WindowState -eq "Maximized") {
                ...
                $dragPrevVars.MaxBtn.Text = [char]0xE922
                $dragPrevVars.StartPoint = New-Object System.Drawing.Point([int]($f.Width / 2), 15)
            } else {
                $dragPrevVars.StartPoint = New-Object System.Drawing.Point($e.X, $e.Y) 
            }
            $dragPrevVars.IsDragging = $true
        } 
    }.GetNewClosure()
    
    $doPrevDrag = { 
        param($s, $e) 
        if ($dragPrevVars.IsDragging) { 
            $f = $dragPrevVars.Form
            $mousePos = [System.Windows.Forms.Cursor]::Position
            $f.Location = New-Object System.Drawing.Point(($mousePos.X - $dragPrevVars.StartPoint.X), ($mousePos.Y - $dragPrevVars.StartPoint.Y)) 
        } 
    }.GetNewClosure()
    
    $stopPrevDrag = { $dragPrevVars.IsDragging = $false }.GetNewClosure()

    $prevTitleBar.Add_MouseDown($startPrevDrag); $lblPrevTitle.Add_MouseDown($startPrevDrag)
    $prevTitleBar.Add_MouseMove($doPrevDrag); $lblPrevTitle.Add_MouseMove($doPrevDrag)
    $prevTitleBar.Add_MouseUp($stopPrevDrag); $lblPrevTitle.Add_MouseUp($stopPrevDrag)
    # =========================================================================
    ...
    $SwitchProfile = {
        ...
        $btnPrevMax.Text = [char]0xE922 # Atualiza visualmente o icone da barra
        ...
        if ($NewProfile -eq "B") {
            ...
            if ($previewMem.B_Max) { 
                $previewForm.WindowState = 'Maximized'
                $btnPrevMax.Text = [char]0xE923 
            }
    ...
    $previewForm.Add_Resize({
        ...
        if ($previewForm.WindowState -eq 'Maximized') {
            ...
            $btnPrevMax.Text = [char]0xE923 # Sincroniza icone da barra
        } 
        elseif ($previewForm.WindowState -eq 'Normal') {
            $btnPrevMax.Text = [char]0xE922 # Sincroniza icone da barra
    ...
    # --- BLINDAGEM DPI NO CODIGO: Usa pixel para nao inflar ---
    $rtbPreview.Font = New-Object System.Drawing.Font("Consolas", 14, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # 5. Componente de Mensagem (Padrao) - AGORA BLINDADO
    $lblPreviewMsg = New-Object System.Windows.Forms.Label
    $lblPreviewMsg.Dock = "Fill"
    $lblPreviewMsg.TextAlign = "MiddleCenter"
    $lblPreviewMsg.ForeColor = "White" # Texto agora eh branco
    # --- BLINDAGEM DPI: Fonte grande travada em 18px ---
    $lblPreviewMsg.Font = New-Object System.Drawing.Font("Segoe UI", 18, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $lblPreviewMsg.Text = "Selecione um arquivo..."
    $previewForm.Controls.Add($lblPreviewMsg)

    # 6. NOVO: BARRA DE STATUS DO PREVIEW (Resolução e Tamanho) - AGORA BLINDADA
    $lblPreviewStatus = New-Object System.Windows.Forms.Label
    $lblPreviewStatus.Dock = "Bottom"
    $lblPreviewStatus.Height = 28
    $lblPreviewStatus.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#2D2D30")
    $lblPreviewStatus.ForeColor = [System.Drawing.ColorTranslator]::FromHtml("#E0E0E0")
    $lblPreviewStatus.TextAlign = "MiddleCenter"
    # --- BLINDAGEM DPI: Texto travado em 12px negrito ---
    $lblPreviewStatus.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    $form.Add_FormClosing({
        try {
            ...
            if ($fontPrevTitle) { $fontPrevTitle.Dispose() }
            if ($fontPrevIcon) { $fontPrevIcon.Dispose() }
        } catch {}
    }.GetNewClosure())
...
# --- BOTÃO EXCLUIR (DEFINITIVO COM ÍCONE NETSHELL) ---
    ...
    # ====================================================================
    # --- BOTÃO BACKUP (MOTOR AVANÇADO COM PRESERVAÇÃO DE ATRIBUTOS) ---
    # ====================================================================
    ...
    $btnBackup.Add_Click({
        if ($tabControl.SelectedTab -and $tabControl.SelectedTab.Controls.Count -gt 0) {
            ...
            try {
                ...
                $btnBackup.BackColor = "#FF8C00" 
                $btnBackup.Enabled = $false
                
                $prgForm = New-Object System.Windows.Forms.Form
                $prgForm.Text = "Backup em Andamento"
                $prgForm.Size = New-Object System.Drawing.Size(420, 140)
                $prgForm.FormBorderStyle = "FixedDialog"
                
                # --- BLINDAGEM DPI ADICIONADA: Desliga a escala automática ---
                $prgForm.AutoScaleMode = [System.Windows.Forms.AutoScaleMode]::None
                
                $prgForm.StartPosition = "CenterScreen"
                $prgForm.TopMost = $true
                $prgForm.ControlBox = $false
                $prgForm.ShowInTaskbar = $false

                $lblPrgStatus = New-Object System.Windows.Forms.Label
                $lblPrgStatus.AutoSize = $false
                $lblPrgStatus.Dock = "Top"
                $lblPrgStatus.Height = 50
                $lblPrgStatus.TextAlign = "MiddleCenter"
                $lblPrgStatus.Text = "Analisando arquivos..."
                
                # --- BLINDAGEM DPI: Fonte travada em 13px exatos em vez de 9pt ---
                $lblPrgStatus.Font = New-Object System.Drawing.Font("Segoe UI", 13, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
                
                $prgForm.Controls.Add($lblPrgStatus)

                $pbBackup = New-Object System.Windows.Forms.ProgressBar
                $pbBackup.Dock = "Bottom"
                $pbBackup.Height = 35
                $pbBackup.Style = "Continuous"
                $prgForm.Controls.Add($pbBackup)

                $prgForm.Show($global:SyncHash.Form)

                $bgScript = {
                    param($items, $form, $btn, $browserControl, $prgForm, $lblStatus, $pb)
                    ...
                    function Get-Signature($path, $isDir) {
                        if (-not (Test-Path -LiteralPath $path)) { return @{ Size = -1; Date = [DateTime]::MinValue } }
                        if ($isDir) {
                            $files = Get-ChildItem -LiteralPath $path -Recurse -File -Force -ErrorAction SilentlyContinue
                            $size = if ($files) { ($files | Measure-Object -Property Length -Sum).Sum } else { 0 }
                            $date = if ($files) { ($files | Sort-Object LastWriteTime -Descending | Select-Object -First 1).LastWriteTime } else { (Get-Item -LiteralPath $path).LastWriteTime }
                    ...
                    # FASE 1: ANÁLISE DE DUPLICATAS E PREPARAÇÃO DA FILA
                    foreach ($item in $items) {
                        $srcPath = $item.Path
                        ...
                        $existingBackups = Get-ChildItem -LiteralPath $backupDir | Where-Object { $_.Name -match "^$([regex]::Escape($baseName))( \(\d+\))?$([regex]::Escape($ext))$" }
                        ...
                        if ($existingBackups) {
                            ...
                            if ($lastBackupIndex -ge 0 -and (Test-Path -LiteralPath $lastBackupPath)) {
                                $tgtSig = Get-Signature $lastBackupPath $isFolder
                                $timeDiff = [math]::Abs(($srcSig.Date - $tgtSig.Date).TotalSeconds)
                                
                                # SE TAMANHO E DATA FOREM IGUAIS, ABORTA ESTE ITEM
                                if ($srcSig.Size -eq $tgtSig.Size -and $timeDiff -lt 2) { 
                                    $countIgnored++ 
                                    continue 
                                }
                            }
                        ...
                        if ($isFolder) {
                            ...
                            $allFiles = Get-ChildItem -LiteralPath $srcPath -Recurse -Force
                            foreach ($f in $allFiles) {
                                $relPath = $f.FullName.Substring($srcPath.Length + 1)
                                $targetSubPath = Join-Path $destPath $relPath
                                if ($f.PSIsContainer) { New-Item -ItemType Directory -Path $targetSubPath -Force | Out-Null } 
                                else { $filesQueue += @{ Src = $f.FullName; Dst = $targetSubPath } }
                            }
                        } else {
                            $filesQueue += @{ Src = $srcPath; Dst = $destPath }
                        }
                        $countSuccess++
                    }

                    # FASE 2: CÓPIA COM PRESERVAÇÃO DE DATA
                    $totalFiles = $filesQueue.Count
                    $currentFileIndex = 0

                    foreach ($fq in $filesQueue) {
                        $currentFileIndex++
                        $sourceFile = $fq.Src
                        $destFile = $fq.Dst
                        $fileNameOnly = Split-Path $sourceFile -Leaf
                        
                        try {
                            $sInfo = Get-Item -LiteralPath $sourceFile
                            $fsIn = [System.IO.File]::OpenRead($sourceFile)
                            $fsOut = [System.IO.File]::Create($destFile)
                            
                            $totalBytes = $fsIn.Length
                            ...
                            while (($read = $fsIn.Read($buffer, 0, $buffer.Length)) -gt 0) {
                                ...
                                if ($totalBytes -gt 0) {
                                    ...
                                    if ($percent -ne $lastPercent) {
                                        $lastPercent = $percent
                                        $msg = "Arquivo $currentFileIndex de $totalFiles`n$fileNameOnly ($percent%)"
                                        $form.BeginInvoke([System.Action]{ $pb.Value = $percent; $lblStatus.Text = $msg }) | Out-Null
                                    }
                                }
                            }
                            $fsIn.Close(); $fsOut.Close()
                            
                            # SINCRONIZA A DATA DE MODIFICAÇÃO
                            (Get-Item -LiteralPath $destFile).LastWriteTime = $sInfo.LastWriteTime
                            
                        } catch {
                            if ($fsIn) { try { $fsIn.Close() } catch {} }
                            if ($fsOut) { try { $fsOut.Close() } catch {} }
                            Copy-Item -LiteralPath $sourceFile -Destination $destFile -Force
                            # Sincroniza data mesmo no modo de resgate
                            try { (Get-Item -LiteralPath $destFile).LastWriteTime = (Get-Item -LiteralPath $sourceFile).LastWriteTime } catch {}
                        }
                    }

                    # FASE 3: RELATÓRIO FINAL
                    $finalMessage = ""
                    $finalTitle = "Backup Inteligente"
                    if ($countIgnored -gt 0 -and $countSuccess -eq 0) {
                        $finalMessage = "Arquivo já existe. Backup abortado para evitar cópias duplicadas."
                        $finalTitle = "Backup Abortado"
                    } elseif ($countSuccess -gt 0 -and $countIgnored -eq 0) {
                        $finalMessage = "O backup dos itens selecionados foi finalizado."
                    } else {
                        $finalMessage = "$countIgnored arquivo(s) ignorado(s) e $countSuccess arquivo(s) concluído(s)."
                    }
                    
                    $uiAction = [System.Action]{
                        $prgForm.Close(); $prgForm.Dispose()
                        if ($btn -ne $null) { $btn.BackColor = "Transparent"; $btn.Enabled = $true }
                        if ($browserControl -ne $null) { try { $browserControl.Refresh() } catch {} }
                        
                        # --- CORREÇÃO MULTI-THREAD: Volta ao controle nativo C# blindado ---
                        [System.Windows.Forms.MessageBox]::Show($finalMessage, $finalTitle, [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
                    }
                    if ($form -ne $null) { $form.BeginInvoke($uiAction) | Out-Null }
                }
                
                $ps = [powershell]::Create()
                $ps.RunspacePool = $global:RunspacePool
                [void]$ps.AddScript($bgScript); [void]$ps.AddArgument($itemsToProcess); [void]$ps.AddArgument($global:SyncHash.Form); [void]$ps.AddArgument($btnBackup); [void]$ps.AddArgument($b); [void]$ps.AddArgument($prgForm); [void]$ps.AddArgument($lblPrgStatus); [void]$ps.AddArgument($pbBackup)
                ...
                $cleanupTimer.Add_Tick({
                    if ($handle.IsCompleted) {
                        $cleanupTimer.Stop()
                        try { $ps.EndInvoke($handle) | Out-Null; $ps.Dispose(); $cleanupTimer.Dispose() } catch {}
                    }
                }.GetNewClosure())
                $cleanupTimer.Start()
            } catch {}
    ...
    # --- BLINDAGEM DPI DO MENU ---
    $menuNew.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $menuNew.ImageScalingSize = New-Object System.Drawing.Size(16, 16)

    # Função auxiliar TOTALMENTE BLINDADA (Auto-Seleção, Renomear, Caminho Real e Motor Híbrido UTF-8)
    $ActionCreateNew = {
        ...
        try {
            if ($TControl.SelectedTab -and $TControl.SelectedTab.Controls.Count -gt 0) {
                ...
                # --- LEITURA DIRETA DO MOTOR COM ---
                $view = $activeBrowser.ActiveXInstance.Document
                $currentPath = ""
                if ($view -and $view.Folder -and $view.Folder.Self) {
                    $currentPath = $view.Folder.Self.Path
                }
                # Fallback de segurança caso o motor COM falhe
                if ([string]::IsNullOrWhiteSpace($currentPath)) {
                    try { $currentPath = $activeBrowser.Url.LocalPath } catch {}
                }
                
                # Bloqueio de pastas virtuais
                if ([string]::IsNullOrWhiteSpace($currentPath) -or $currentPath -match "^::" -or $currentPath -match "^search-ms:") {
                    # --- SUBSTITUÍDO PELA NOSSA MENSAGEM BLINDADA ---
                    global:Show-MsgBox "Navegue até uma pasta real para criar arquivos." "Aviso"
                    if ($view) { [System.Runtime.InteropServices.Marshal]::ReleaseComObject($view) | Out-Null }
                    return
                }
                ...
                # Adicionado -LiteralPath para evitar bugs com pastas que contenham [colchetes] no nome
                ...
                # --- CRIAÇÃO COM TRAVA E MOTOR HÍBRIDO DE CODIFICAÇÃO ---
                if ($IsFolder) {
                    New-Item -ItemType Directory -Path $fullPath -ErrorAction Stop | Out-Null
                } else {
                    # Lógica Inteligente: Só usa BOM onde é necessário/seguro (.ps1, .csv, .txt)
                    if ($Extension -match "\.(ps1|csv|txt)$") {
                        $utf8 = New-Object System.Text.UTF8Encoding($true)  # COM BOM
                    } else {
                        # Para .bat e outras linguagens, força SEM BOM para não quebrar compiladores
                ...
                if ($view) {
                    ...
                    # Libera a memória do motor COM logo após terminar o uso
                    [System.Runtime.InteropServices.Marshal]::ReleaseComObject($view) | Out-Null
                }
                
            } else {
                # --- SUBSTITUÍDO PELA NOSSA MENSAGEM BLINDADA ---
                global:Show-MsgBox "Nenhuma aba ativa encontrada." "Aviso"
            }
        } catch {
            # --- SUBSTITUÍDO PELA NOSSA MENSAGEM BLINDADA ---
            global:Show-MsgBox "Ocorreu um erro:`n$_" "Erro do Sistema"
        }
    }
    ...
    $btnNew.Text = "+"
    # --- BLINDAGEM DPI: Fonte travada em píxeis absolutos (16px) ---
    $btnNew.Font = New-Object System.Drawing.Font("Segoe UI", 16, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # --- BLINDAGEM DPI: Fonte travada em píxeis absolutos ---
    $btnFav.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # --- BLINDAGEM DPI: Fonte travada em píxeis absolutos ---
    $btnBack.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # --- BLINDAGEM DPI: Fonte travada em píxeis absolutos ---
    $btnFwd.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # --- BLINDAGEM DPI: 12pt convertido para 16px cravados ---
    $btnUp.Font = New-Object System.Drawing.Font("Consolas", 16, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # --- BLINDAGEM DPI: 10pt convertido para 13px cravados ---
    $txtPath.Font = New-Object System.Drawing.Font("Segoe UI", 13, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # ====================================================================
    # --- BOTÃO "+" FIXO E INDICADORES (BLINDADOS CONTRA DPI) ---
    # ====================================================================
    ...
    # --- BLINDAGEM DPI: 10pt convertido para 14px cravados ---
    $btnNewTab.Font = New-Object System.Drawing.Font("Consolas", 14, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    # --- BLINDAGEM DPI: 12pt convertido para 16px cravados ---
    $lblMoreLeft.Font = New-Object System.Drawing.Font("Consolas", 16, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
    ...
    $tabControl.Add_DrawItem({ param($s, $e)
        try {
			...
			# --- BLINDAGEM DPI: Força o "x" a ter exatamente 11px em vez de 8pt inchados ---
            $xFont = [System.Drawing.Font]::new("Consolas", 11, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
...
# --- ARRASTAR E SOLTAR ABAS ---
   ...
   # --- MENU DE CONTEXTO DAS ABAS (CLIQUE DIREITO) ---
    ...
    # --- BLINDAGEM DPI DO MENU (Evita botões e fontes gigantes) ---
    $tabContextMenu.Font = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
    $tabContextMenu.ImageScalingSize = New-Object System.Drawing.Size(16, 16)
    ...
    # ====================================================================
    # --- MOTOR DE MENSAGENS BLINDADO (ESCOPO GLOBAL) ---
    # ====================================================================
    function global:Show-MsgBox {
        param($mensagem, $titulo = "Aviso", $tipo = "OK")
        
        $msgForm = New-Object System.Windows.Forms.Form
        $msgForm.Size = New-Object System.Drawing.Size(380, 160)
        ...
        $msgForm.BackColor = [System.Drawing.Color]::White

        $fBold = New-Object System.Drawing.Font("Segoe UI", 13, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
        $fReg = New-Object System.Drawing.Font("Segoe UI", 12, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)
        ...
        $titleBar = New-Object System.Windows.Forms.Panel
        $titleBar.Dock = "Top"; $titleBar.Height = 32; $titleBar.BackColor = [System.Drawing.Color]::WhiteSmoke
        $msgForm.Controls.Add($titleBar)

        $lblTitle = New-Object System.Windows.Forms.Label
        $lblTitle.Dock = "Fill"; $lblTitle.Text = "  $titulo"; $lblTitle.TextAlign = "MiddleLeft"
        $lblTitle.Font = $fBold
        $titleBar.Controls.Add($lblTitle)

        $drag = @{ IsDragging = $false; Start = $null }
        $md = { param($s, $e) if ($e.Button -eq 'Left') { $drag.IsDragging = $true; $drag.Start = New-Object System.Drawing.Point($e.X, $e.Y) } }.GetNewClosure()
        $mm = { param($s, $e) if ($drag.IsDragging) { $mp = [System.Windows.Forms.Cursor]::Position; $msgForm.Location = New-Object System.Drawing.Point(($mp.X - $drag.Start.X), ($mp.Y - $drag.Start.Y)) } }.GetNewClosure()
        $mu = { $drag.IsDragging = $false }.GetNewClosure()
        $titleBar.Add_MouseDown($md); $titleBar.Add_MouseMove($mm); $titleBar.Add_MouseUp($mu)
        $lblTitle.Add_MouseDown($md); $lblTitle.Add_MouseMove($mm); $lblTitle.Add_MouseUp($mu)

        $lblMsg = New-Object System.Windows.Forms.Label
        $lblMsg.Text = $mensagem
        $lblMsg.Font = $fReg
        $lblMsg.TextAlign = "MiddleCenter"; $lblMsg.Dock = "Fill"
        $msgForm.Controls.Add($lblMsg)

        $btnPanelMsg = New-Object System.Windows.Forms.Panel
        $btnPanelMsg.Dock = "Bottom"; $btnPanelMsg.Height = 50; $btnPanelMsg.BackColor = [System.Drawing.Color]::WhiteSmoke
        $msgForm.Controls.Add($btnPanelMsg)

        if ($tipo -eq "YesNo") {
            $btnYes = New-Object System.Windows.Forms.Button
            $btnYes.Text = "Sim"; $btnYes.Font = $fReg; $btnYes.DialogResult = "Yes"
            $btnYes.Size = New-Object System.Drawing.Size(80, 30); $btnYes.Location = New-Object System.Drawing.Point(100, 10)
            $btnPanelMsg.Controls.Add($btnYes)

            $btnNo = New-Object System.Windows.Forms.Button
            $btnNo.Text = "Não"; $btnNo.Font = $fReg; $btnNo.DialogResult = "No"
            $btnNo.Size = New-Object System.Drawing.Size(80, 30); $btnNo.Location = New-Object System.Drawing.Point(190, 10)
            $btnPanelMsg.Controls.Add($btnNo)
        } else {
            $btnOk = New-Object System.Windows.Forms.Button
            $btnOk.Text = "OK"; $btnOk.Font = $fReg; $btnOk.DialogResult = "OK"
            $btnOk.Size = New-Object System.Drawing.Size(80, 30); $btnOk.Location = New-Object System.Drawing.Point(150, 10)
            $btnPanelMsg.Controls.Add($btnOk)
        }

        $res = $msgForm.ShowDialog()
        $msgForm.Dispose(); $fBold.Dispose(); $fReg.Dispose()
        return $res
    }
    ...
    $btnFav.Add_Click({
        ...
        try {
            ...
            if ($isFav) {
                # --- SUBSTITUÍDO: Usando a nossa Mensagem Blindada ---
                if ((Show-MsgBox "Remover '$currentName' dos favoritos?" "Remover Favorito" "YesNo") -eq 'Yes') {
                    Remove-FavoriteByPath -PathToRemove $currentPath
                    if ($global:StarEmptyIconBmp) { $btnFav.Image = $global:StarEmptyIconBmp }
                }
            } else {
                # --- SUBSTITUÍDO: Usando a nossa Mensagem Blindada ---
                $choice = Show-MsgBox "Deseja escolher a pasta de destino?" "Novo Favorito" "YesNo"
                if ($choice -eq 'Yes') {
